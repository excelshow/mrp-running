    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header clearfix">
          <a href="{{ url('master/master-materials/maintenance-data/create') }}" class="btn btn-primary pull-right">Create</a>
        </div>
        <div class="box-body">
            ...
            <tbody>
              @foreach ($materials as $item)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('master.master-materials.maintenance-data.edit', $item->id) }}" class="btn btn-info"">
      ...
      $(document).on('click', '.remove-item', function(e){
        ...
        swal({
          ...
          if (isConfirm) {
            $.ajax({
              type: "DELETE",
              url: "{{ url('master/master-materials/maintenance-data') }}"+"/"+id,
