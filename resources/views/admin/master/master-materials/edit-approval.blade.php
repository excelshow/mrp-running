  ...
  <div class="row">
   <div class="col-md-12">
     <div class="box">
      ...
      <div class="box-body">
        {!! Form::model($material, ['route' => ['master.master-materials.approval.update', encrypt($material->id)],'method' =>'put','role'=>'form','files' => true])!!}
        {{ csrf_field() }}
        ...
        <div class="row">
          <div class="col-md-12">
            <hr>
                <center>
                    <a href="{{ url('master/master-materials/approval') }}" class="btn btn-default">
