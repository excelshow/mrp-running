    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header clearfix">
          <a href="{{ url('planning/labors/create') }}" class="btn btn-primary pull-right">Create</a>
        </div>
        <div class="box-body">
            ...
            <tbody>
              @foreach ($labors as $item)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('planning.labors.edit', $item->id) }}" class="btn btn-xs btn-info"">
