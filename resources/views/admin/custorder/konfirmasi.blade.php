...
<section class="content-header">
  <h1>
    {{substr(Route::currentRoutename(),9)}} Konfirmasi
    <small></small>
  </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
      <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#tab_4" data-toggle="tab">Konfirmasi</a></li>
            </ul>
        ...
        <div class="box-body">
         ...
         {{csrf_field()}}
          ...
          <div class="form-group">
             <div class="col-md-12"> 
              <a  style="float: right" id="btn5" class="btn btn-primary">Selanjutnya</a>
            </div>
      </div>
    </div>
              </div>
         ...
         {{csrf_field()}}
          @section('editMethod')
           ...
           <div class="form-group">
            <div class="col-md-5"> 
              <label class="control-label" for="first-name"><h1>Konfirmasi Pesanan ?</h1> </label>
          ...
          <div class="form-group">
             <div class="col-md-12"> 
              <a  id="btn6" class="btn btn-warning">Konfirmasi</a> &nbsp; 
              <a  id="btn7" class="btn btn-danger">Batal</a>
