...
@section('title', 'Manufacturing Bill of Materials Assy | ')

@section('content')
<section class="content-header">
  <h1>
    Manufacturing Bill of Materials Assy
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Manufacturing Bill of Materials Assy</li>
  </ol>
</section>
            ...
            <tbody>
              @foreach ($materials as $item)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('engineering.m-bom.assy.edit', $item->id) }}" class="btn btn-xs btn-info"">
      ...
      $(document).on('click', '.remove-item', function(e){
        ...
        swal({
          ...
          if (isConfirm) {
            $.ajax({
              type: "DELETE",
              url: "{{ url('engineering/m-bom/assy') }}"+"/"+id,
