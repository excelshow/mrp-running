...
@section('title', 'Approval Master Material | ')

@section('content')
<section class="content-header">
  <h1>
    Approval Master Material
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Approval Master Material</li>
  </ol>
</section>
  ...
  <div class="row">
   <div class="col-md-12">
     <div class="box">
      ...
      <div class="box-body">
        {!! Form::model($material, ['route' => ['engineering.master-materials.approval.update', encrypt($material->id)],'method' =>'put','role'=>'form','files' => true])!!}
        {{ csrf_field() }}
        ...
        <div class="row">
          <div class="col-md-12">
            <hr>
                <center>
                    <a href="{{ url('engineering/master-materials/approval') }}" class="btn btn-default">
