...
class LaborsController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['labors'] = $labors;
        return view('admin.master.labors.index', $data);
    }
    ...
    {
        return view('admin.master.labors.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('master/reference/labors');
    }
    ...
    public function edit($id)
    {
        ...
        $data['labor'] = $labor;
        return view('admin.master.labors.edit', $data);
    }
